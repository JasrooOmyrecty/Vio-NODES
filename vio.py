...
ADMIN_IDS = [1319328459570282576,1305505649018277908]  # Replace with actual admin IDs
...
async def change_status():
    try:
        ...
        status = f" VIO NODES {instance_count} VPS"
...
async def deploy_with_os(interaction, os_type, ram, cpu, user_id, user, container_name, expiry_date):
    ...
    if ssh_session_line:
        ...
        dm_embed.add_field(name="🔒 Password", value="VIONODES", inline=False)
...
async def sendvps(
    ...
    embed.set_footer(text="🔐 Safe your details | Powered by VIO NODES")
